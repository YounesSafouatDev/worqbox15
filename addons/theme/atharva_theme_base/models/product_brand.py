...
class ProductBrand(models.Model):
    ...
    brand_product_ids = fields.One2many('product.template','product_website_brand_id', string='Brand Products',)
    ...
    def as_get_brand_product(self):
        ...
        result = {
            ...
            "domain": [['product_website_brand_id', '=', self.id]],
            "name": "Products",
...
class ASProductTemplateExtend(models.Model):
    ...
    product_website_brand_id = fields.Many2one('as.product.brand', string='Brand', help='Select a brand for this product')